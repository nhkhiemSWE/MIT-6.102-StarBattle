...
const clientADT_1 = require("../src/clientADT");
...
describe('Client ADT Tests', function () {
    ...
    it('toString + getStatus, empty Puzzle', function () {
        const emptyPuzzle = (0, Parser_1.emptyPuzzleParser)(emptyPuzzleString);
        const client = new clientADT_1.Client(emptyPuzzle);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set(), "no star has been placed yet");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    it('toString + getStatus + addStar, partitially solved Puzzle', function () {
        const emptyPuzzle = (0, Parser_1.emptyPuzzleParser)(emptyPuzzleString);
        const client = new clientADT_1.Client(emptyPuzzle);
        client.addStar(1, 2);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set().add([1, 2]), "incorrect stars after adding");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    it('toString + getStatus + addStar, correctly solved Puzzle', function () {
        ...
        solve(client);
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        assert_1.default.deepStrictEqual(getStars(client.toString()), getStars(solvedPuzzleString), "incorrect stars after adding");
        (0, assert_1.default)(client.getStatus(), "the puzzle is solved correctly");
    });
    it('toString + getStatus + addStar, partitially but incorrectly solved Puzzle, cells are adjacent', function () {
        ...
        client.addStar(1, 1);
        client.addStar(1, 2);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set([[1, 1], [1, 2]]), "incorrect stars after adding");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    it('toString + getStatus + addStar, partitially but incorrectly solved Puzzle, 3 cells in a row', function () {
        ...
        client.addStar(1, 3);
        client.addStar(1, 5);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set([[1, 1], [1, 3], [1, 5]]), "incorrect stars after adding");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    it('toString + getStatus + addStar, partitially but incorrectly solved Puzzle, 3 cells in a col', function () {
        ...
        client.addStar(3, 1);
        client.addStar(5, 1);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set([[1, 1], [3, 1], [5, 1]]), "incorrect stars after adding");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    it('toString + getStatus + addStar, partitially but incorrectly solved Puzzle, 3 cells in a region', function () {
        ...
        client.addStar(4, 8);
        client.addStar(3, 6);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set([[2, 7], [3, 6], [4, 8]]), "incorrect stars after adding");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    it('toString + getStatus + addStar, partitially but incorrectly solved Puzzle, the whole puzzle fills with stars', function () {
        ...
        assert_1.default.deepStrictEqual(getStars(client.toString()), expectedSet, "incorrect stars");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    // Test addStar()
    it('addStar, add a star twice to a position', function () {
        ...
        client.addStar(1, 2);
        client.addStar(1, 2);
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set().add([1, 2]), "incorrect stars");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
    // Test removeStar()
    ...
    it('refresh, empty puzzle', function () {
        ...
        const client = new clientADT_1.Client(emptyPuzzle);
        client.refresh();
        assert_1.default.deepStrictEqual(getStars(client.toString()), new Set(), "incorrect stars");
        assert_1.default.deepStrictEqual(getRegions(client.toString()), getRegions(emptyPuzzleString), "regions must be the same");
        (0, assert_1.default)(!client.getStatus(), "the puzzle is unsolved");
    });
